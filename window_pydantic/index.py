...
class Window(ThemedTk):
    def __init__(self, **kwargs):
        ...
        ttk.Button(func_frame, text="AQI最好的5個").pack(side='left', expand=True)
        ttk.Button(func_frame, text="AQI最差的5個").pack(side='left', expand=True)
        ttk.Button(func_frame, text="pm2.5最好的5個").pack(side='left', expand=True)
        ttk.Button(func_frame, text="pm2.5最差的5個").pack(side='left', expand=True)

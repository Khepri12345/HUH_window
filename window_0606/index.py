...
class Window(ThemedTk):
    ...
    def click2(self):
        ...
        message = "\n".join(message_data)
        print(message)
        ShowInfo(parent=self,title="全台aqi最差前5個區域", message=message)
    ...
    def click4(self):        
        ...
        message = "\n".join(message_data)
        print(message)
        ShowInfo(parent=self,title="全台pm2.5最差前5個區域", message=message)
...
class ShowInfo(Dialog):
    ...
    def body(self, master: Frame) -> Misc | None:
        text = tk.Text(self, height=8, font=('Helvetica',10), width=50)
    ...
    def buttonbox(self) -> None:
        ...
        self.ok_button.pack(pady=(20,20), ipady=10)
        box.pack()
